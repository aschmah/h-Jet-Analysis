...
void runGridESD(TString mode="terminate",Int_t sub=702, TString fname="Ali_AS_analysis_TRD_digits", Int_t alien=1)
{
    ...
    // aliroot runGridESD.C\(\"test\",704,\"Ali_AS_analysis_TRD_digits\",0\)
    // aliroot runGridESD.C\(\"test\",704,\"Ali_AS_analysis_TRD_digits\",1\)
    // aliroot runGridESD.C\(\"full\",704,\"Ali_AS_analysis_TRD_digits\",1\)
    // aliroot runGridESD.C\(\"terminate\",704,\"Ali_AS_analysis_TRD_digits\",1\)
    ...
    //gROOT->LoadMacro("$ALICE_PHYSICS/OADB/macros/AddTaskCentrality.C"); // Run 1
    ...
    gROOT->LoadMacro("$ALICE_PHYSICS/OADB/COMMON/MULTIPLICITY/macros/AddTaskMultSelection.C"); // ROOT 5
    ...
    //if(intMCrunning==0)
    //{
    //correctionTask->SetUserConfigurationFilename("/home/joshua/PCG_Software/LocalTrainTest/corrFrameworkSettings/userConfigurationppNewDefault.yaml");
    //}
    //else
    //{
    //correctionTask->SetUserConfigurationFilename("/home/joshua/PCG_Software/LocalTrainTest/corrFrameworkSettings/userConfigurationppMCSimple.yaml");
    //if(mode == "full")
    //{
    //    correctionTask->SetUserConfigurationFilename("alien::///alice/cern.ch/user/a/aschmah/Data/userConfigurationppSimple.yaml");
    //}
    //else
    //{
    correctionTask->SetUserConfigurationFilename("/home/ceres/schmah/ALICE/Jet_Analysis/EMCal/userConfigurationppSimple.yaml");
    //}
    //}
    correctionTask->Initialize(true);


    //taskNameSpecial                 = "CellTMNL";
    ...
    //if(intMCrunning==0)
    //correctionTaskSpezial->SetUserConfigurationFilename("/home/joshua/PCG_Software/LocalTrainTest/corrFrameworkSettings/PWGGA_CF_config_CellTM.yaml");
    //correctionTaskSpezial->SetUserConfigurationFilename("alien::///alice/cern.ch/user/a/aschmah/Data/userConfigurationppSimple.yaml");
    //correctionTaskSpezial->SetUserConfigurationFilename("/home/ceres/schmah/ALICE/Jet_Analysis/EMCal/userConfigurationppSimple.yaml");
    //correctionTaskSpezial->SetUserConfigurationFilename("/home/joshua/PCG_Software/LocalTrainTest/corrFrameworkSettings/PWGGA_CF_config_CellTM.yaml");
    //else
    //correctionTaskSpezial->SetUserConfigurationFilename("/home/joshua/PCG_Software/LocalTrainTest/corrFrameworkSettings/PWGGA_CF_config_MC_CellTM.yaml");
    //correctionTaskSpezial->Initialize(true);
    //---------------------------------------------------------------
...
AliAnalysisGrid* CreateAlienHandler(TString mode="test",Int_t sub=0,TString fname="testName")
{
	...
	for(Int_t irun = 0; irun < 1; irun++) // 10 < 11 produced
	{
    ...
    plugin->SetAdditionalLibs("StJetTrackEvent.h StJetTrackEventLinkDef.h Ali_AS_Event.h Ali_AS_EventLinkDef.h Ali_AS_analysis_TRD_digits.h Ali_AS_analysis_TRD_digits.cxx");
